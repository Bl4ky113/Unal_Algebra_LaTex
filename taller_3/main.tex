    ...
    \begin{itemize}
        ...
        \item La recta \(\fancyL_2\) y el plano \(\fancyP_2\) se interceptan en: \\
            ...
            \[
                ...
                0
            \]
            Como \(d_2 \cdot n_2 \neq 0\), ahora sabemos que \(\fancyL_2\) no es paralela a \(\fancyP_2\), el cual elimina la opción de una intersección de 
            infinitos puntos y ningún punto. Ya \(\fancyL_2\) por definición tampoco puede estar contenida en \(\fancyP_2\).
            Sin embargo, podemos verificar si \(\fancyL_2\) y \(\fancyP_2\) son ortogonales, viendo si el producto cruz entre \(d_2\) y \(n_2\) es igual al vector nulo.
            \[
                d_2 \times n_2 =
                \begin{pmatrix}
                    -2 \\ 8 \\ -4
                ...
                \vec{0}
            \]
            Como \(d_2 \parallel n_2\) entonces \(\fancyL_2 \perp \fancyP_2\), por lo que nos confirma que \(\fancyL_2\) solo corta a \(\fancyP_2\) en un solo punto.
